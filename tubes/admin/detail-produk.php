...
<html lang="en">
    ...
    <title>Pharmacy | Detail Produk</title>
    ...
    <div class="container">
        <div class="col-12 col-md-6">
            ...
            <div>
                ...
                <img src="../img/<?= $data['foto'] ?>" alt="" width="200px" class="mt-3">
            </div>
            <div>
            ...
            <div class="mt-2">
                <button type="submit" class="btn btn-primary mb-2" name="editBtnProduk">Edit</button>
                <button type="submit" class="btn btn-danger mb-2" name="deleteBtnProduk">Delete</button>
            </div>
            </form>

            <?php
                if(isset($_POST['editBtnProduk'])) {
            ...
            <?php
                ...
                if(isset($_POST['deleteBtnProduk'])) {
